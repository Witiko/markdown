unprotectedRenderers = {%
  ...
  *LineBreak = {%
  ...
  blockQuote(Begin|End) = {%
    \TYPE{#0}},
  blockHtml(Comment|StandaloneTag) = {%
    \TYPE{#0: #1}},
  lineBlock(Begin|End) = {%
    \TYPE{#0}},
  inputVerbatim = {%
  ...
  inlineHtml(Comment|Tag) = {%
    \TYPE{#0: #1}},
  inlineHtml(ProcessingInstruction|Declaration|CdataSection|OpenTag|CloseTag|EmptyTag) = {%
    \TYPE{#0: #1}},
  inputBlockHtmlElement = {%
    \TYPE{#0: \NORMALIZEPATH{#1}}},
  inputBlockHtml(CdataElement|ProcessingInstruction|Declaration|CdataSection|PcdataElement) = {%
    \TYPE{#0: \NORMALIZEPATH{#1}}},
